...
pub struct GotoTable {
    ...
    augmented_start_index: Option<usize>,
}
...
impl GotoTable {
    pub fn new(state_count: usize, non_terminal_count: usize) -> Self {
        GotoTable {
            ...
            non_terminal_count,
            augmented_start_index: None,
        }
    }

    pub fn set_augmented_start(&mut self, id: NonTerminalId) {
        self.augmented_start_index = Some(id.0);
    }

    fn is_augmented_start_column(&self, nt: usize) -> bool {
        self.augmented_start_index.map_or(false, |idx| idx == nt)
    }
    ...
    pub fn print(&self, non_terminal_names: &[String]) {
        ...
        for nt in 0..self.non_terminal_count {
            if self.is_augmented_start_column(nt) {
                continue;
            }
